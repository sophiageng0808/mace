...
REPULSION_MODELS = [
    ("r12",     str(JOBS_ROOT / "309421_2_repulsion_r12" / "repulsion_r12.model")),
    ("zbl",     str(JOBS_ROOT / "309419_1_repulsion_zbl" / "repulsion_zbl.model")),
    ("zbl_r12", str(JOBS_ROOT / "309413_3_repulsion_zbl_r12" / "repulsion_zbl_r12.model")),
]
...
def main():
    ...
    failed_csv = SCRATCH_MACE / "outputs" / "dissociation_scans_overfit100" / "repulsion" / "slurm_309754" / "zbl" / "failed_curves_metrics.csv"
