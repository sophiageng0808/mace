#!/bin/bash
#SBATCH --job-name=mace_repulsion_no_gate
...
PAIR_EMB_TUNED="--pair_repulsion_embedding --pair_repulsion_symmetric_pair_feat True --pair_repulsion_gate none --pair_repulsion_alpha_hidden_dim 16 --pair_repulsion_alpha_reg 1e-2 --pair_repulsion_alpha_min 0.85 --pair_repulsion_alpha_max 1.15"
